    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                String[] simpleWeatherStrings = OpenWeatherJsonUtils
        ...
        @Override
        protected void onPostExecute(String[] simpleWeatherStrings) {
            if (simpleWeatherStrings != null) {
                for (String simpleWeatherString : simpleWeatherStrings) {
                    mWeatherTextView.append(simpleWeatherString + "\n\n\n");
                }
            }
        }
    }
