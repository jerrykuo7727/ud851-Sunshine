...
public class DetailActivity extends AppCompatActivity implements
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        ...
        String humidityStringA11y = getString(R.string.a11y_humidity);

        /* Set the text to display the humidity */
        mDetailBinding.extraWeatherDetails.humidity.setText(humidityString);
        mDetailBinding.extraWeatherDetails.humidity.setContentDescription(humidityStringA11y);

        mDetailBinding.extraWeatherDetails.humidityLabel.setContentDescription(humidityStringA11y);
        ...
        String windStringA11y = getString(R.string.a11y_wind);
        ...
        String pressureStringA11y = getString(R.string.a11y_pressure);
